...
export class HomePage{
  ...
  settings() {
    let pin = this.modal.create(PinPage);
    pin.onDidDismiss((data) => {
      console.log(data);
      if(data.pin == '2489') this.modal.create(AppSettings).present();
    })
    pin.present();
  }
}
...
function CanvasAnimation() {
  ...
  this.dotCount = 20;
  this.dot;
  this.dotColors = [ {r:0,g:51,b:51}, {r:51,g:102,b:102}, {r:153,g:153,b:204},{r:153,g:204,b:204} ]
  this.size = {
    x: 0,
    y: 0
  }
